...
impl MintbaseStoreFactory {
    ...
    pub fn get_minimum_attached_balance(&self) -> U128 {
        (storage_bytes::STORE as u128 * self.storage_price_per_byte
            + self.mintbase_fee)
            .into()
    }
    ...
    pub fn set_storage_price_per_byte(&mut self, new_price: U128) {
        ...
        self.store_cost =
            self.storage_price_per_byte * storage_bytes::STORE as u128;
    }
    ...
    pub fn create_store(
        ...
        Promise::new(store_account_id.clone())
            ...
            .deploy_contract(
                include_bytes!("../../wasm/mb-nft-v1.wasm").to_vec(),
            )
...
impl New for NFTContractMetadata {
    fn new(args: NFTContractMetadata) -> Self {
        let store_account =
            format!("{}.{}", args.name, env::current_account_id());
        assert!(
